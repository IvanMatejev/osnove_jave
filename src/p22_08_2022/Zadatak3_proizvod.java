...
public class Zadatak3_proizvod {
...
//		konstuktore
		...
		ClanskaKarta karta = new ClanskaKarta(10, "565-85");
		Kupac pera = new Kupac("Pera Peric", karta );
		Proizvod proizvod = new Proizvod("torba", 500, pera);
