...
public class Zadatak2_agencija {
...
//		Dana (dan.mesec.godina.)god sklopljen je ugovor izmedju (print prodavca) i (print kupca) o kupovini nekretnine (adresa) po 
//		ceni od (cena nekretnin) pri cemu je kupac u obavezi da agenciji isplati novcanu vrednost u iznosu od (zarada agencije)

		FizickoLice kupac = new FizickoLice("Pera Peric", "123456789", "2505885457788", true);
		FizickoLice prodavac = new FizickoLice("Ivan Matejev", "256485", "1808993750027", false);
		
		Ugovor kupoprodaja = new Ugovor("23.8.2022.", prodavac, kupac, 50000, "Bulevar 25");
		kupoprodaja.print();
	}
