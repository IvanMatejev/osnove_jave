...
//				U glavnom programu kreirati objekte definisanih klasa i testirati rad definisanih funkcija 
		...
		host.setImePrezime("Pera Peric");
		host.pretplatiSe(150);
		
		Korisnik guest1 = new Korisnik();
		guest1.setImePrezime("Ivan Matejev");
		
		
		ZoomCall call1 = new ZoomCall("asasasasas", "12345678", host);
	
		call1.setGuest(guest1);
